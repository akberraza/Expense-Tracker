...
import { addThousandsSep } from '../../utils/helper';
      ...
      <div className='my-5 mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          ...
          <InfoCard
            icon={<IoMdCard />}
            label="Total Balance"
            value={addThousandsSep(dashboardData?.totalBalance || 0)}
            color="bg-primary"
          />
          ...
          <InfoCard
            ...
            label="Total Income"
            value={addThousandsSep(dashboardData?.totalIncome || 0)}
            color="bg-orange-500"
          />
          ...
          <InfoCard
            icon={<LuHandCoins />}
            label="Total Expense"
            value={addThousandsSep(dashboardData?.totalExpense || 0)}
            color="bg-red-500"
          />
